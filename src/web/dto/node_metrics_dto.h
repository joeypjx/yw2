// ============================================================================
// 文件功能描述：
// 节点指标DTO（node_metrics_dto）的头文件，定义节点指标API响应的数据传输对象。
// 主要功能包括：
// 1. 节点指标定义：定义NodeMetrics结构体，用于/node/metrics API的响应数据
// 2. 最新指标定义：定义LatestCpuMetrics、LatestMemoryMetrics等结构体，表示各项资源的最新指标
