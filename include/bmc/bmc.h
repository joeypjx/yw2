// ============================================================================
// 文件功能描述：
// BMC模块（IBMCModule）的头文件，定义BMC管理模块的公共接口。
// 主要功能包括：
// 1. BMC信息查询接口：提供查询所有机箱和指定机箱BMC信息的接口
// 2. 板卡状态查询：提供查询板卡在位状态（PRST）的接口
// 3. 传感器数据查询：提供查询BMC传感器最新数据和历史数据的接口
// 4. 工厂模式：提供BMCFactory工厂类，用于创建BMC模块实例
// 5. 接口抽象：定义IBMCModule接口，隐藏具体实现细节，实现模块间的松耦合
// ============================================================================
