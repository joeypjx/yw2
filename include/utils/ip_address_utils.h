// ============================================================================
// 文件功能描述：
// IP地址工具类（IPAddressUtils）的头文件，定义板卡IP地址计算和解析的接口。
// 主要功能包括：
// 1. IP地址计算：提供calculateHostIP方法，根据机箱号和槽位号计算板卡的IP地址
// 2. IP地址解析：提供parseHostIP方法，从IP地址反向解析出机箱号和槽位号
// 3. IP地址验证：提供isValidBoardIP方法，验证IP地址是否为有效的板卡IP地址
